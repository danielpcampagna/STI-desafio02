...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { address: @station.address, code: @station.code, latitude: @station.latitude, longitude: @station.longitude, neighborhood: @station.neighborhood, number: @station.number, station: @station.station } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { address: @station.address, code: @station.code, latitude: @station.latitude, longitude: @station.longitude, neighborhood: @station.neighborhood, number: @station.number, station: @station.station } }
